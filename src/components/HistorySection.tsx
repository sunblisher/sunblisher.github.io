      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h3 className="text-xl mb-8 text-white">Work Experience</h3>
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                ...
                >
                  <div className="absolute left-0 top-0 w-4 h-4 bg-white rounded-full transform -translate-x-2"></div>

                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 shadow-lg hover:shadow-xl hover:bg-white/15 transition-all duration-300">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                      <h4 className="text-lg text-white">{exp.position}</h4>
                    ...
                    <div className="space-y-2">
                      <h5 className="text-sm text-white">주요 성과</h5>
                ...
                <div className="space-y-4">
                  {certifications.map((cert, index) => (
                    <motion.div
                      ...
                      className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 shadow-lg hover:shadow-xl hover:bg-white/15 transition-all duration-300"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-sm mb-1 text-white">
                            {cert.name}
                          </h4>
