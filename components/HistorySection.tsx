...
const experiences = [
  {
    ...
    period: '2022.03 - 현재',
    location: '서울, 대한민국',
    description: '사용자 중심의 디자인 시스템 구축 및 제품 전략 수립을 담당하고 있습니다.',
    achievements: [
  ...
  },
  {
    ...
    location: '서울, 대한민국',
    description: '다양한 클라이언트의 웹사이트 퍼블리싱 및 프론트엔드 개발을 담당했습니다.',
    achievements: [
  ...
  },
  {
    ...
    location: '원격 근무',
    description: '소규모 비즈니스와 스타트업을 위한 브랜딩 및 웹 개발 서비스를 제공했습니다.',
    achievements: [
...
export function HistorySection() {
  ...
  return (
    <section id="history" className="py-20 bg-muted/30" ref={ref}>
