...
const projects: ProjectData[] = [
  {
    ...
    category: '디자인 작업물',
    description: '사용자 경험을 중심으로 한 이커머스 플랫폼의 전면 리디자인 프로젝트입니다. 기존의 복잡한 구조를 단순화하고, 직관적인 네비게이션과 모던한 디자인으로 전환율을 35% 향상시켰습니다.',
  ...
  },
  {
    ...
    title: '기업 웹사이트 구축',
    category: '퍼블리싱 작업물',
    description: 'React와 TypeScript를 활용한 기업 공식 웹사이트 개발 프로젝트입니다. 성능 최적화와 SEO를 고려하여 개발했으며, 모든 디바이스에서 완벽한 사용자 경험을 제공합니다.',
  ...
  },
  {
    ...
    title: '모바일 앱 UI 디자인',
    category: '디자인 작업물',
    description: '헬스케어 분야의 모바일 애플리케이션 UI/UX 디자인 프로젝트입니다. 사용자의 건강 데이터를 직관적으로 시각화하고, 간편한 상호작용을 통해 일상 건강 관리를 도와줍니다.',
  ...
  },
  {
    ...
    title: 'SaaS 대시보드 개발',
    category: '퍼블리싱 작업물',
    description: '데이터 분석을 위한 SaaS 플랫폼의 관리자 대시보드 개발 프로젝트입니다. 복잡한 데이터를 직관적인 차트와 그래프로 시각화하여 사용자가 쉽게 인사이트를 얻을 수 있도록 구현했습니다.',
              ...
              >
                <div className="bg-background rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                  <div className="aspect-video overflow-hidden">
                    <ImageWithFallback
                      src={project.images[0]?.url || 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop'}
                      alt={project.title}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-xs text-primary font-normal">{project.category}</span>
